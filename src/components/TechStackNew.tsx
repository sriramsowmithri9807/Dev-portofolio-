...
const techStack: TechItem[][] = [
  // Row 1 - 12 items (largest) — Core Languages & AI Frameworks
  [
  ...
  // Row 2 - 10 items — Frameworks & Backend
  [
  ...
  // Row 5 - 4 items — AI Ecosystem
  [
    { name: "Hugging Face", icon: "https://huggingface.co/front/assets/huggingface_logo-noborder.svg", url: "https://huggingface.co" },
    { name: "LangChain", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://python.langchain.com" },
    { name: "OpenAI", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://openai.com" },
    { name: "YOLO", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", url: "https://docs.ultralytics.com" },
  ],
  // Row 6 - 2 items (tip of pyramid) — Research
  [
